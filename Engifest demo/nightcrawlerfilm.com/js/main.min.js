...
NC.PoliceScanner = function () {
    ...
    animateIn: function () {
        var t = this;
        this.el.style.visibility = "hidden", t.nums.style.color = "rgba(255,255,255,0.6)", TweenMax.to(this.el, .5, {
            x: 0,
            ease: Expo.easeOut
...
NC.VolumeUp = function () {
    ...
    init: function () {
        ...
        this.el = H.createEl("div", {
            ...
            letterSpacing: "1px",
            color: "rgba(255,255,255,0.5)"
        }, this.el), this.zeros = H.createEl("div", {
            position: "absolute",
            top: "-1000px",
            left: "0px",
            width: "202px",
...
NC.Nav = function () {
    ...
    init: function () {
        ...
        this.wrapper.appendChild(l.el), a.push(l), this.navItems.push(a), this.buttonsCast = H.createEl("div", {
            width: "150px",
            cssFloat: "left"
        }, this.buttons, "navHeader"), this.buttonsCast.innerHTML = "<h1>ATTRACTIONS</h1>", this.wrapper = H.createEl("div", null, this.buttonsCast, "navWrapper");
        var u = [];
        ...
        if (this.navItems.push(u), site.data.pages.length > 4) {
            this.buttonsTickets = H.createEl("div", {
                width: "215px",
                cssFloat: "left"
            }, this.buttons, "navHeader"), this.buttonsTickets.innerHTML = "<h1>REGISTER</h1>", this.wrapper = H.createEl("div", null, this.buttonsTickets, "navWrapper");
            var c = [],
            ...
            .click(function () {
                ...
                onready: function () {
                    soundManager.createSound({
                        ...
                        id: "loop1",
                        url: "assets/audio/loops/Young Again" + H.soundExt,
                        autoLoad: !0,
                        onfinish: function () {
